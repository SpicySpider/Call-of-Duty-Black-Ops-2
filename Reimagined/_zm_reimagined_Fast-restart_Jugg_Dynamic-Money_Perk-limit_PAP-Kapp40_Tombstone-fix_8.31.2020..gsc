...
onplayerspawned()
{
	...
	for(;;)
	{
		...
		myattempt();
			...
			self GiveWeapon("kard_upgraded_zm");
			self GiveMaxAmmo("kard_upgraded_zm");
		...
		if (self.initial_spawn)
		{
			...
			self GiveWeapon("kard_upgraded_zm");
			self GiveMaxAmmo("kard_upgraded_zm");
			self iprintlnbold("Welcome^2 "+self.name +"^7 to ^1SpicySpider's^7 Server");
			wait 6;
			self iprintlnbold("^2" +self.name + "^7, your perk limit has been removed");
			wait 4;
			self iprintlnbold("^7Enjoy ^6Extra Dynamic Points^7,^4 Increased Perk Limit^7,^5 UI changes^7,^2 Fast Restart ^7,^1 Juggernog ^7, and MUCH more");
			wait 6;	
